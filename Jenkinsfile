pipeline{
    ...
    stages{
        ...
        stage ('Execute Playbook') {
            steps{
                ansiblePlaybook become: true, credentialsId: '9f4ccbec-2822-42be-b293-185a33da3328', disableHostKeyChecking: true, inventory: '/etc/ansible/hosts', playbook: '/etc/ansible/deployApp.yml'
            }
        }
    }
}
