pipeline{
    ...
    stages{
        ...
        stage ('Execute Playbook') {
            steps{
                ansiblePlaybook credentialsId: 'Ansible-Jenkins', disableHostKeyChecking: true, installation: 'Ansible', inventory: '/etc/ansible/hosts', playbook: '/etc/ansible/deployApp.yml'
            }
        }
    }
}
